...
module.exports = function(args, index, config) {
  ...
  // files in index, files in each folder
  // you can deduce from that what is out of date
  // look at mtimes and see what is out of date
  // offer suggestions, like, you should run scrawl build
};
